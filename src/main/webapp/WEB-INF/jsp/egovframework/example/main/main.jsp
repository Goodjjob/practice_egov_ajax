...
/* $("[class*=btn-fill]").text("힌큐");
	alert($("span").length); */
	
	$(".content > button").text("한큐");
});
	...
	<div class="card">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="content">
					<button id="defautld" class="btn btn-default btn-fill btn-wd">Default</button>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="content">
					...
					<button type="button" class="btn btn-wd btn-default">
						Right <span class="btn-label btn-label-right"> <i
